...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      <div className='hidden lg:flex items-center bg-gray-200 rounded-md p-2 text-[14px]'>
        <p className='bg-black text-white rounded-md p-2'>Delievry</p>
        <p className='p-2'>Pick Up</p>
        </div>
      </div>

      {/* Search imput */}
<div className='bg-gray-200 rounded-md flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px] '> <AiOutlineSearch size={25}/>
      <input className='bg-transparent p-2 w-full focus:outline-none' type="text" placeholder='Search ...' /></div>
     
{/* Cart button */}
<button className='bg-black text-white hidden md:flex items-center py-2 rounded-md'>
